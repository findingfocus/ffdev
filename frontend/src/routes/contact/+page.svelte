...
<div class="mx-8 md:mx-auto flex flex-col items-center justify-center gap-8 mt-3">
    <div class="flex items-center justify-center w-full">
        <Card class="bg-gray-900 border border-blue-800/30 shadow-lg shadow-blue-900/20 dark:bg-gray-900 dark:border-blue-800/20 max-w-sm rounded-xl p-6">
