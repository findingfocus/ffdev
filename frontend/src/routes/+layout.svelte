...
<!--	NAVBAR-->
    ...
    <footer class="relative text-center w-full min-h-[64px] flex items-center justify-center z-10 md:z-30 pb-[60px] md:pb-0">
        <div class="flex justify-between items-center gap-5 px-4 py-3 w-full max-w-[360px] md:max-w-[400px] md:gap-8 md:px-0 md:py-4 ml-5 translate-y-4 md:translate-y-3">
            <a href="https://www.youtube.com/findingfocus" target="_blank" rel="noopener noreferrer" aria-label="YouTube Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#FF0000] hover:scale-[1.05] transition duration-300 ease-in-out" viewBox="0 0 24 24">
            ...
            <a href="https://www.github.com/findingfocus" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#6CC644] hover:scale-[1.05] transition duration-300 ease-in-out" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/findingfocusdev" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#0077B5] hover:scale-[1.05] transition duration-300 ease-in-out" viewBox="0 0 24 24">
            ...
            <a href="https://www.twitch.tv/findingfocusdev" target="_blank" rel="noopener noreferrer" aria-label="Twitch Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#9146FF] hover:scale-[1.05] transition duration-300 ease-in-out" viewBox="0 0 24 24">
        ...
        <style>
            footer::before {
                ...
                position: absolute;
                inset: 0;
                background: linear-gradient(to top, black, rgba(8, 15, 50, 0.65));
                filter: saturate(60%);
                z-index: -10;
            }
        </style>
