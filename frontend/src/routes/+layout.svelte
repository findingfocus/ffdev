...
<!--	NAVBAR-->
    ...
    <footer class="bg-gradient-to-t from-black to-[rgba(8,15,50,0.65)] text-center w-full min-h-[64px] flex items-center justify-center z-10 md:z-30 pb-[60px] md:pb-0 saturate-60">
        <div class="flex justify-between items-center gap-5 px-4 py-3 w-full max-w-[360px] md:max-w-[400px] md:gap-8 md:px-0 md:py-4 ml-5 translate-y-4 md:translate-y-2">
            <a href="https://www.youtube.com/findingfocus" target="_blank" rel="noopener noreferrer" aria-label="YouTube Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white saturate-100 hover:fill-[#FF0000] hover:saturate-100 hover:scale-[1.1] transition duration-300 ease-in-out" viewBox="0 0 24 24">
            ...
            <a href="https://www.github.com/findingfocus" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#6CC644] hover:scale-[1.1] transition duration-300 ease-in-out" viewBox="0 0 24 24">
                    <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"/>
                </svg>
            </a>
            <a href="https://www.linkedin.com/in/findingfocusdev/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#0077B5] hover:scale-[1.1] transition duration-300 ease-in-out" viewBox="0 0 24 24">
            ...
            <a href="https://www.twitch.tv/findingfocusdev" target="_blank" rel="noopener noreferrer" aria-label="Twitch Profile">
                <svg class="w-14 h-14 md:w-14 md:h-14 fill-white hover:fill-[#9146FF] hover:scale-[1.1] transition duration-300 ease-in-out" viewBox="0 0 24 24">
